    ...
    <div class="app-container">
        <el-card class="show">
            ...
            <el-table :data="list" row-key="id" ref="dragTable" v-fixed-scroll>
                ...
                <el-table-column label="商品" prop="agent_info_arr.name" />
        ...
        v-if="drawerFormVisible"
            :visible.sync="drawerFormVisible" :direction="'rtl'" :append-to-body="true" :modal-append-to-body="false"
            size="50%"
...
<script>
import { lists, edit } from "@/api/order/agent";
