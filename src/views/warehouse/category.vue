        ...
        >
            <el-form :model="form" :rules="rules" ref="ruleForm" label-width="90px">
                ...
                <el-form-item label="归属" prop="belong">
                    <el-radio-group v-model="form.belong" @change="$forceUpdate()">
                        <el-radio :label="1">职校家园</el-radio>
                        <el-radio :label="2">工学云</el-radio>
                    </el-radio-group>
                </el-form-item>
...
<script>
import { lists, edit, update, create, del } from "@/api/warehouse/category";
